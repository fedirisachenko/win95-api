...
export class Migration20260429211340 extends Migration {
    override async up(): Promise<void> {
        this.addSql(
            `create table "achievement" ("id" uuid not null, "user_id" uuid not null, "type" smallint not null, "progress" int not null default 0, "completed" smallint not null default -1, "metadata" jsonb not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, constraint "achievement_pkey" primary key ("id"));`,
        );
        this.addSql(
